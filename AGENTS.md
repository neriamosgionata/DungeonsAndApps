...
*Last updated: 2026-06-16 (combat audit Sprint 2: 9 desync + reaction fixes + 7 tests + pending_hits queue; see `COMBAT_AUDIT_2026_06_16.md`). Keep in sync with project evolution.*
