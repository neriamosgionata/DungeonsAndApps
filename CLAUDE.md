...
_Last updated: 2026-06-19 (Sprint 14: i18n cleanup round 2 — 60+ new keys × 2 locales; all 11 form components now use $_() for button labels, dropdowns, status messages, ability codes, and 18 skill names (SkillForm); hardcoded error messages in forms extracted.)_
