...
_Last updated: 2026-06-19 (Sprint 11: 4 RMW race fixes (move_combatant/class_feature/apply_spell_outcome/start.rs) via SELECT FOR UPDATE in tx; 4 frontend path fixes (opp-attack dedupe, Roster double search, Banner .replace i18n, 2× loadList dedupe). All combat tests 278/278 pass; vitest 630.)_
