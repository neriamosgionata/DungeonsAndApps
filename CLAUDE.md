...
_Last updated: 2026-06-19 (Sprint 26: start_encounter N+1 fix — per-row UPDATE loop replaced with single batched UPDATE using ROW_NUMBER() OVER. For N combatants: N UPDATEs → 1.)_
