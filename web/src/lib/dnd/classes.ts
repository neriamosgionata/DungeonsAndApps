...
export const DND_SUBCLASSES: Record<DndClass, readonly SubclassOption[]> = {
  ...
  Fighter: [
    ...
    { name: 'Rune Knight',          source: 'UA, 2017' },
  ...
  Monk: [
    ...
    { name: 'Way of the Sun Soul',                   source: 'PHB, 2014' },
  ...
  Sorcerer: [
    ...
    { name: 'Divine Soul',       source: 'SCAG/TCoE, 2017' },
    ...
    { name: 'Storm Sorcery',     source: 'PHB, 2014' },
  ...
  Warlock: [
    ...
    { name: 'Undying',                              source: 'UA, 2017' },
    { name: 'Undead',                               source: "Van Richten's Guide, 2021" },
    { name: 'The Noble Genie',                      source: 'UA, 2017' },
